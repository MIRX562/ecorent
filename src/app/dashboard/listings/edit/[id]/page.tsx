...
import { ArrowLeft, Trash2, Upload, X, Calendar } from "lucide-react"
  ...
  useEffect(() => {
    const fetchListing = async () => {
      ...
      try {
        ...
        // For this example, we'll use the sample data after a short delay
        ...
        form.reset({
          ...
          pricingUnit: sampleListing.pricingUnit,
          deposit: sampleListing.deposit,
          category: sampleListing.category,
          condition: sampleListing.condition,
          location: sampleListing.location,
          features: sampleListing.features,
          rules: sampleListing.rules,
          isActive: sampleListing.isActive,
          isInstantBook: sampleListing.isInstantBook,
        })

        // Set features and rules
        setFeatures(sampleListing.features)
        setRules(sampleListing.rules)

        // Set images
        setImages(
          sampleListing.images.map((image) => ({
            preview: image,
          })),
        )
      } catch (error) {
      ...
      {isLoading ? (
        ...
        <Alert className="bg-green-50 dark:bg-green-950/20 border-green-200 dark:border-green-900">
          <AlertDescription className="text-green-800 dark:text-green-300">
            Listing updated successfully! Redirecting to listing details...
          </AlertDescription>
        </Alert>
      ) : (
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            <Tabs defaultValue="basic" className="w-full">
              <TabsList className="grid w-full grid-cols-3 mb-4">
                <TabsTrigger value="basic" id="basic-tab">
                  Basic Information
                </TabsTrigger>
