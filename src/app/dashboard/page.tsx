...
export default function DashboardPage() {
  // Example usage for demo listings
  const tentImg = usePixabayImage(
    "Camping Tent",
    "https://pixabay.com/api/?key=50978905-d1ce30881d322635459928df1&q=tent&image_type=photo&per_page=3"
  );
  const bikeImg = usePixabayImage(
    "Mountain Bike",
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          Welcome back, John! Here's an overview of your EcoRent activity.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              <span className="text-green-500 font-medium">+2</span> new this
              month
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              <span className="text-amber-500 font-medium">1</span> due this
              week
            </p>
          </CardContent>
        </Card>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Ryan K. left a 5-star review for your DSLR Camera
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      You listed "Power Drill Set" for $15/day
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-lg border p-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Wants to rent your Mountain Bike
                    </p>
                  </div>
                </div>
              ...
              <div className="rounded-lg border p-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Wants to rent your Power Drill Set
                    </p>
                  </div>
                </div>
                <div className="mt-2 text-xs text-muted-foreground">
